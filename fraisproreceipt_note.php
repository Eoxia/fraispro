...
/**
 *  \file       htdocs/modulebuilder/template/fraisproreceipt_note.php
 *  \ingroup    fraispro
 *  \brief      Tab for notes on FraisproReceipt
 */
...
$title = $langs->trans('FraisproReceipt').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("FraisproReceipt"), -1, $object->picto);
