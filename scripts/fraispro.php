...
/**
 *      \file       htdocs/modulebuilder/template/scripts/fraispro.php
 *		\ingroup    fraispro
 *      \brief      This file is a command line script for module Fraispro. You can execute it with:
 *      			php fraispro/scripts/fraispro.php
 */
