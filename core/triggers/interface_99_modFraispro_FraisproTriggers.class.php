...
/**
 * \file    core/triggers/interface_99_modFraispro_FraisproTriggers.class.php
 * \ingroup fraispro
 * \brief   Example of trigger file.
 *
 * You can create other triggered files by copying this one.
 * - File name should be either:
 *      - interface_99_modFraispro_MyTrigger.class.php
...
/**
 *  Class of triggers for Fraispro module
 */
class InterfaceFraisproTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Fraispro triggers.";
