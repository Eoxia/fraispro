...
/**
 * \file    htdocs/modulebuilder/template/core/boxes/fraisprowidget1.php
 * \ingroup fraispro
 * \brief   Widget provided by Fraispro
 *
 ...
 */
class fraisprowidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "fraisprobox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "fraispro@fraispro";
	 ...
	 */
	public $lang = 'fraispro@fraispro';

	/**
	 * @var string[] Module dependencies
	 */
	public $depends = array('fraispro');
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("FraisproBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_fraispro@fraispro',
			...
			'subclass' => 'center',
			// Limit and truncate with "â€¦" the displayed text length, 0 = disabled
			'limit' => 0,
	...
	{
		// You may make your own code hereâ€¦
