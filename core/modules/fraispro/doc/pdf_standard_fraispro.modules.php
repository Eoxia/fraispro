 ...
 * Copyright (C) 2018-2025  Fr̩d̩ric France				<frederic.france@free.fr>
...
/**
 *  \file       htdocs/modulebuilder/template/core/modules/fraispro/doc/pdf_standard.modules.php
 *  \ingroup    fraispro
...
class pdf_standard_fraispro extends ModelePDFFraispro
{
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('FRAISPRO_DRAFT_WATERMARK') && $object->status == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('FRAISPRO_DRAFT_WATERMARK')));
		}
