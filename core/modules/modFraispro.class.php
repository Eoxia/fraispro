...
/**
 * 	\defgroup   fraispro     Module Fraispro
 *  \brief      Fraispro module descriptor.
 *
 *  \file       htdocs/fraispro/core/modules/modFraispro.class.php
 *  \ingroup    fraispro
 *  \brief      Description and activation file for module Fraispro
 */
include_once DOL_DOCUMENT_ROOT.'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Fraispro
 */
class modFraispro extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		// Module label (no space allowed), used if translation string 'ModuleFraisproName' not found (Fraispro is name of module).
		$this->name = preg_replace('/^mod/i', '', get_class($this));

		// DESCRIPTION_FLAG
		// Module description, used if translation string 'ModuleFraisproDesc' not found (Fraispro is name of module).
		$this->description = "FraisproDescription";
		...
		// Key used in llx_const table to save module status enabled/disabled (where FRAISPRO is value of property name of module in uppercase)
		...
		$this->module_parts = array(
			...
			'css' => array(
				//    '/fraispro/css/fraispro.css.php',
			),
			// Set this to relative path of js file if module must load a js on all pages
			'js' => array(
				//   '/fraispro/js/fraispro.js.php',
			),
		...
		// Example: this->dirs = array("/fraispro/temp","/fraispro/subdir");
		$this->dirs = array("/fraispro/temp");

		// Config pages. Put here list of php page, stored into fraispro/admin directory, to use to setup module.
		$this->config_page_url = array("setup.php@fraispro");
		...
		$this->langfiles = array("fraispro@fraispro");
		...
		//$this->automatic_activation = array('FR'=>'FraisproWasAutomaticallyActivatedBecauseOfYourCountryChoice');
		//$this->always_enabled = true;								// If true, can't be disabled

		// Constants
		// List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 'current' or 'allentities', deleteonunactive)
		// Example: $this->const=array(1 => array('FRAISPRO_MYNEWCONST1', 'chaine', 'myvalue', 'This is a constant to add', 1),
		//                             2 => array('FRAISPRO_MYNEWCONST2', 'chaine', 'myvalue', 'This is another constant to add', 0, 'current', 1)
		// );
		$this->const = array();
		...
		if (!isModEnabled("fraispro")) {
			$conf->fraispro = new stdClass();
			$conf->fraispro->enabled = 0;
		}
		...
		// $this->tabs[] = array('data' => 'objecttype:+tabname1:Title1:mylangfile@fraispro:$user->hasRight(\'fraispro\', \'read\'):/fraispro/mynewtab1.php?id=__ID__');
		// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
		// $this->tabs[] = array('data' => 'objecttype:+tabname2:SUBSTITUTION_Title2:mylangfile@fraispro:$user->hasRight(\'othermodule\', \'read\'):/fraispro/mynewtab2.php?id=__ID__',
		...
		/* Example:
		 ...
		 'tabcond' => array(isModEnabled('fraispro'), isModEnabled('fraispro'), isModEnabled('fraispro')),
		...
		// Boxes/Widgets
		// Add here list of php file(s) stored in fraispro/core/boxes that contains a class to show a widget.
		/* BEGIN MODULEBUILDER WIDGETS */
		$this->boxes = array(
			//  0 => array(
			//      'file' => 'fraisprowidget1.php@fraispro',
			//      'note' => 'Widget provided by Fraispro',
		...
		$this->cronjobs = array(
			...
			//      'unitfrequency' => 3600,
			//      'status' => 0,
			//      'test' => 'isModEnabled("fraispro")',
			//      'priority' => 50,
			//  ),
		);
		/* END MODULEBUILDER CRON */
		// Example: $this->cronjobs=array(
		//    0=>array('label'=>'My label', 'jobtype'=>'method', 'class'=>'/dir/class/file.class.php', 'objectname'=>'MyClass', 'method'=>'myMethod', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>2, 'unitfrequency'=>3600, 'status'=>0, 'test'=>'isModEnabled("fraispro")', 'priority'=>50),
		//    1=>array('label'=>'My label', 'jobtype'=>'command', 'command'=>'', 'parameters'=>'param1, param2', 'comment'=>'Comment', 'frequency'=>1, 'unitfrequency'=>3600*24, 'status'=>0, 'test'=>'isModEnabled("fraispro")', 'priority'=>50)
		// );
	...
	public function init($options = '')
	{
		...
		//$result0=$extrafields->addExtraField('fraispro_separator1', "Separator 1", 'separator', 1,  0, 'thirdparty',   0, 0, '', array('options'=>array(1=>1)), 1, '', 1, 0, '', '', 'fraispro@fraispro', 'isModEnabled("fraispro")');
		//$result1=$extrafields->addExtraField('fraispro_myattr1', "New Attr 1 label", 'boolean', 1,  3, 'thirdparty',   0, 0, '', '', 1, '', -1, 0, '', '', 'fraispro@fraispro', 'isModEnabled("fraispro")');
		//$result2=$extrafields->addExtraField('fraispro_myattr2', "New Attr 2 label", 'varchar', 1, 10, 'project',      0, 0, '', '', 1, '', -1, 0, '', '', 'fraispro@fraispro', 'isModEnabled("fraispro")');
		//$result3=$extrafields->addExtraField('fraispro_myattr3', "New Attr 3 label", 'varchar', 1, 10, 'bank_account', 0, 0, '', '', 1, '', -1, 0, '', '', 'fraispro@fraispro', 'isModEnabled("fraispro")');
		//$result4=$extrafields->addExtraField('fraispro_myattr4', "New Attr 4 label", 'select',  1,  3, 'thirdparty',   0, 1, '', array('options'=>array('code1'=>'Val1','code2'=>'Val2','code3'=>'Val3')), 1,'', -1, 0, '', '', 'fraispro@fraispro', 'isModEnabled("fraispro")');
		//$result5=$extrafields->addExtraField('fraispro_myattr5', "New Attr 5 label", 'text',    1, 10, 'user',         0, 0, '', '', 1, '', -1, 0, '', '', 'fraispro@fraispro', 'isModEnabled("fraispro")');
