...
/**
 *	\file       htdocs/modulebuilder/template/fraisproindex.php
 *	\ingroup    fraispro
 *	\brief      Home page of fraispro top menu
 */
...
$langs->loadLangs(array("fraispro@fraispro"));
...
llxHeader("", $langs->trans("FraisproArea"), '', '', 0, 0, '', '', '', 'mod-fraispro page-index');

print load_fiche_titre($langs->trans("FraisproArea"), '', 'fraispro.png@fraispro');
