...
/**
 *  \file       htdocs/modulebuilder/template/fraispro_note.php
 *  \ingroup    fraispro
 *  \brief      Tab for notes on Fraispro
 */
...
$title = $langs->trans('Fraispro').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Fraispro"), -1, $object->picto);
