...
/**
 *  \file       htdocs/modulebuilder/template/fraisproreceipt_contact.php
 *  \ingroup    fraispro
 *  \brief      Tab for contacts linked to FraisproReceipt
 */
...
$title = $langs->trans("FraisproReceipt")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("FraisproReceipt"), -1, $object->picto);
