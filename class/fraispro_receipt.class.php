 ...
 * Class for Fraispro
 */
class FraisproReceipt extends CommonObject
{
	/**
	 ...
	 */
	public $element = 'fraispro_receipt';

	/**
	 * @var string 		Name of table without prefix where object is stored. This is also the key used for extrafields management (so extrafields know the link to the parent table).
	 */
	public $table_element = 'fraispro_receipt';
	...
	public function getNextNumRef()
	{
		...
		if (!getDolGlobalString('FRAISPRO_FRAISPRORECEIPT_ADDON')) {
			$conf->global->FRAISPRO_FRAISPRORECEIPT_ADDON = 'mod_fraisproreceipt_standard';
		}

		if (getDolGlobalString('FRAISPRO_FRAISPRORECEIPT_ADDON')) {
			$mybool = false;

			$file = getDolGlobalString('FRAISPRO_FRAISPRORECEIPT_ADDON').".php";
			$classname = getDolGlobalString('FRAISPRO_FRAISPRORECEIPT_ADDON');
