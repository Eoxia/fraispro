 ...
 * Copyright (C) 2024-2025  Fr̩d̩ric France         <frederic.france@free.fr>
...
if (empty($reshook)) {
	...
	$triggermodname = 'FRAISPRO_MYOBJECT_MODIFY'; // Name of trigger action code to execute when we modify record
