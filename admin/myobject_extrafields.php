...
$langs->loadLangs(array('fraispro@fraispro', 'admin'));
...
$elementtype = 'fraispro_myobject'; //Must be the $table_element of the class that manage extrafield
...
llxHeader('', $langs->trans("FraisproSetup"), $help_url, '', 0, 0, '', '', '', 'mod-fraispro page-admin_extrafields');
...
print dol_get_fiche_head($head, 'myobject_extrafields', $langs->trans($page_name), -1, 'fraispro@fraispro');
