...
/**
 * \file    test/phpunit/FraisproFunctionalTest.php
 * \ingroup fraispro
 ...
 *
 * @package Testfraispro
 * @phan-file-suppress PhanPluginUnknownObjectMethodCall,PhanUndeclaredMethod,PhanNonClassMethodCall
 */
class FraisproFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase  // @phan-suppress-current-line PhanUndeclaredExtendedClass
{
	...
	private static $module_id = 436355; // TODO: autodetect?
	...
	{
		$this->url('/custom/fraispro/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('fraispro/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/fraispro/admin/about.php');
		$this->authenticate();
		return $this->assertContains('fraispro/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('fraisprowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modFraispro_FraisproTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFraispro_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
